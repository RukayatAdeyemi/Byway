...
//Ensure one review per user and per course
reviewSchema.index({ course: 1, user: 1}, { unique: true});

//Static Method that calculate average rating for a course
...
reviewSchema.post("save", function() {
    this.constructor.calcAverageRating(this.course)  //check constructor error
});
